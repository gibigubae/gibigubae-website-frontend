            ...
            try {
                ...
                const formatted = attData.data
                    .map((rec) => ({
                        ...
                        rawDate: rec.attendance.date,
                        date: new Date(rec.attendance.date).toLocaleDateString("en-US", {
                            month: "short",
                            day: "numeric",
                            year: "numeric",
                        }),

                        // API does not provide time fields — use fallback
                        timeStart: rec.attendance.time_start || "",
                        timeEnd: rec.attendance.time_end || "",

                        // Convert boolean present → human readable status
                        status:
                            rec.present === null
                                ? "pending"
                                : rec.present
